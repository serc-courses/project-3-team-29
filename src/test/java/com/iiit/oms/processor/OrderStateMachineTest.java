...
class OrderStateMachineTest {
    ...
    void shouldTransitionOrderFromPlannedToPlaced() {
        Order order = new Order("ORD001", "FND001", BigDecimal.TEN, BigDecimal.valueOf(1000), "ACCT00001",
                OrderSide.BUY);
        ...
        OrderManager manager = new OrderManager(mockAccountRepo, mockFundRepo, null);
    ...
    void shouldMoveOrderToErroredWhenAnyStateFails() {
        Order order = new Order("ORD002", "FND002", BigDecimal.ONE, BigDecimal.valueOf(250), "ACCT00002",
                OrderSide.SELL);
